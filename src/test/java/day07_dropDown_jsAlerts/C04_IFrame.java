...
public class C04_IFrame {
    ...
    public void iframeTest() throws InterruptedException {
        ...
        // yani elementi bulamadi kontrol ederken istedigimiz webelement'in
        ...
        // driver.switchTo().parentFrame(); // bulundugu iframe'den bir ust
        // html sayfasina gecer
        // bu daha cok ic icice iframe'ler oldugunda tercih edilir

        driver.switchTo().defaultContent();
        // anasayfaya geçiş yapar

        WebElement elemantalSeleniumLinkElementi =
                driver.findElement(By.xpath("//div[text()='Powered by ']"));
